...
export default function VendorLayout({ children }: { children: React.ReactNode }) {
    ...
    const navItems = [
        ...
        { name: "Add Product", href: "/vendor/products/new" },
    ...
    return (
        <div className="flex h-screen bg-gray-50 font-sans text-gray-900">
            ...
            <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
                {/* <div className="p-6 font-bold text-xl border-b border-gray-100">b2b Marketplace</div> */}
                ...
                <div className="p-4 border-t border-gray-200">
                    <button 
                        ...
                        className="text-red-600 font-medium px-4 py-2 w-full text-left hover:bg-red-50 rounded"
                    >
                        Log Out
                    </button>
                </div>
